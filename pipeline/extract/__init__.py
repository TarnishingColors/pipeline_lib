    ...
    def __init__(self,
        ...
        if enable_hive_support:
            self.spark = (SparkSession
                          ...
                          .config("spark.hadoop.hive.compactor.initiator.on", "true")
                          .config("spark.hadoop.hive.compactor.worker.threads", 1)
                          .config("spark.hadoop.hive.txn.manager", "org.apache.hadoop.hive.ql.lockmgr.DbTxnManager")
                          .enableHiveSupport()
                          .getOrCreate()
                          )
        else:
